					...
					<tbody>
						...
						foreach($results as $result) : ?>
							...
							<tr>
								...
								?></td>
								<td><a target="_blank" class="nav-link" href="<?php echo $result['access_card_pdf_path']; ?>">Access Card</a></td>
								<td><?php 
		...
		<div class="row mb-5">
			<div class="col-md-6">
				...
				<form action="register_member.php" method="post" enctype="multipart/form-data">
					...
					<div id="dropzone-upload" class="dropzone" style="width: 100%; height: 20vh; border: 1px solid black;"></div>
			...
			<div class="col-md-6">
				...
				<form action="register_trainer.php" method="POST">
					...
					<input type="hidden" name="photo_trainer" id="trainerPathInput">
					<div id="drop-upload" class="dropzone mt-3" style="width: 100%; height: 20vh; border: 1px solid black;"></div>
		...
		<div class="row">
			<div class="col-md-6">
				...
				<label>Select Member</label>
					...
					<button type="submit" class="btn btn-primary mt-3 mb-3">Assign Trainer</button>
				</form>
			</div>
		</div>
			...
			init: function() {
				this.on("success", function (file, response) {
					...
					if (jsonResponse.success) {
						// Set the hidden input's value to the upload file's path
		...
		Dropzone.options.dropUpload = {
			...
			init: function() {
				this.on("success", function (file, response) {
					...
					if (jsonResponse.success) {
						// Set the hidden input's value to the upload file's path
						document.getElementById('trainerPathInput').value = jsonResponse.photo_path;
					} else {
						console.error(jsonResponse.error);
					}
				});
